...
let config = {
    ...
    module: {
        rules: [
            ...
            {
                test: /\.(scss|sass)$/,
                use: ['style-loader', withSourceMap('css-loader'), withSourceMap('sass-loader')],
            },
            {
                test: /\.css$/,
    ...
    config = {
        ...
        module: {
            ...
            rules: [
                ...
                {
                    test: /\.(scss|sass)$/,
                    use: [MiniCssExtractPlugin.loader, withSourceMap('css-loader'), withSourceMap('sass-loader')],
                },
                {
                    test: /\.css$/,
                    use: [MiniCssExtractPlugin.loader, withSourceMap('css-loader')],
                },
