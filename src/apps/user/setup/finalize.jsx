...
const Finalize = withForm(
    withActions(
        ({
            ...
            const properties = Object.entries(td['contact-data'].properties).map(
                ([k, v]) => {
                    const items = Object.entries(v.values).map(([kv, vv]) => (
                        <li key={kv}>
                            ...
                            <label htmlFor={kv}>
                                <Trans
                                    id={`contact-data.properties.${k}.values.${kv}`}
                                />
                            </label>
                        </li>
                    ));
                    ...
                    return (
                        <F key={k}>
                            <h2>
                                <Trans
                                    id={`contact-data.properties.${k}.title`}
                                />
                            </h2>
                        ...
                        <CardContent>
                            ...
                            <div className="kip-finalize-fields">
                                ...
                                <RetractingLabelInput
                                    ...
                                    label={<Trans id="contact-data.zip-code" />}
                                />
                                <label
