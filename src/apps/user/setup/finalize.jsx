                ...
                const properties = Object.entries(
                    ...
                    const items = Object.entries(v.values).map(([kv, vv]) => (
                        <li key={kv}>
                            ...
                            <label htmlFor={kv}>
                                <Trans
                                    id={
                                        contactDataPropertiesMessages[k].values[
                                            kv
                                        ]
                                    }
                                />
                    ...
                    return (
                        <F key={k}>
                            <h2>
                                <Trans
                                    id={contactDataPropertiesMessages[k].title}
                                />
                            </h2>
                            ...
                            failedMessage = (
                                <Message type="danger">
                                    <Trans id="wizard.failed.invalid-code">
                                        ...
                                        bereits benutzt. Du kannst sich nicht
                                    ...
                                    >
                                        ...
                                        <span className="kip-control-notice">
                                            <Trans id="contact-data.distance.notice">
                                                Achtung: Du kannst den Radius
                                                derzeit nur 1x einstellen und
                                                nicht mehr ändern!
                                            </Trans>
                                        </span>
                                    </label>
