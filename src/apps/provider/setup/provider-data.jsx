            ...
            <React.Fragment>
                ...
                <label htmlFor="description">
                    <Trans id="provider-data.description">
                        Informationen für Impfwillige (z.B. wenn Sie spezielle
                        Impfstoffe nur bestimmten Gruppen empfehlen)
                    </Trans>
                </label>
                <textarea
                    id="description"
                ...
                <RetractingLabelInput
                    ...
                    description={
                        <Trans id="provider-data.access-code.description">
                            Falls Sie einen spezifischen Zugangscode erhalten
                            haben geben Sie diesen bitte hier ein.
                        </Trans>
                    }
                    label={
