            ...
            if (action === 'backup') {
                    ...
                    >
                        <p>
                            <Trans id="backup-modal.text">
                                ...
                                Termindaten zu erzeugen. Bitte denken Sie daran,
                                den Datenschlüssel zu notieren, ohne diesen sind
                                die Daten nicht wiederherstellbar.
                            </Trans>
                        </p>
                        <hr />
                        <DataSecret
                ...
                modal = (
                    <Modal
                        ...
                        waiting={deleting}
                        title={
                            <Trans id="delete-modal.title">
                                Nutzer-Daten löschen
                            </Trans>
                        }
                        onCancel={cancel}
                        onSave={deleteData}
                        ...
                        <CardContent>
                            ...
                            <p style={{ marginBottom: '1em' }}>
                                <Trans id="provider-data.verified-vs-unverifired-desc">
                                    ...
                                    unsererseits. Sobald Ihre Daten überprüft
                                    wurden, werden Sie Impfwilligen angezeigt.
                                    Führen Sie nach der Überprüfung Ihrer Daten
                                    noch Änderungen dieser durch, so müssen
                                    diese erneut Überprüft werden und werden
                                    entsprechend erst nach erfolgreicher
                                    Überprüfung Impfwilligen angezeigt. Daher
                                    differenzieren wir zwischen verifizierten
                                    und unverifizierten Daten.
                                </Trans>
                            </p>
